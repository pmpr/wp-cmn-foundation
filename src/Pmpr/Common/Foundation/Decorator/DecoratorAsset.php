...
class DecoratorAsset extends Decorator
{
    ...
    public static function ousmawwywumikwwc($ywmkwiwkosakssii = [])
    {
        ...
        wwsomoigcwkwsguy:
        if (!function_exists("\x77\160\137\x65\156\161\x75\x65\x75\145\137\x63\157\144\x65\137\145\144\x69\164\157\x72")) {
    ...
    public static function mkaaikgsosqiaiqg(string $eueuqacmukymcyya, $ogomymegcoacqisg, $ugmuiugkaygmsagq = [], $cksswamugeeeawgw = false, $qsmqqqccagyuaiso = "\x61\154\154") : bool
    {
    ...
    {
        $icwicymcioeyeyek = DecoratorHook::sscegwueamckwmcy("\167\160\x5f\141\x64\x64\137\151\156\154\x69\156\145\x5f\163\x74\171\154\145\x5f\144\141\164\141", $icwicymcioeyeyek, $eueuqacmukymcyya);
    ...
    public static function yocqwqycwegayowg(string $eueuqacmukymcyya, ?string $icwicymcioeyeyek = '', string $kuuiuigeacouwmaa = "\141\146\x74\145\x72")
    {
        $icwicymcioeyeyek = DecoratorHook::sscegwueamckwmcy("\167\x70\x5f\x61\x64\x64\x5f\151\156\x6c\151\x6e\x65\x5f\163\x63\162\x69\160\164\137\144\x61\164\x61", $icwicymcioeyeyek, $eueuqacmukymcyya);
