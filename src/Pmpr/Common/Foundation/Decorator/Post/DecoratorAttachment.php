...
class DecoratorAttachment extends Common
{
    ...
    public static function iaykyouimqoikagg($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\164\x68\165\155\x62\156\141\x69\154", $wkaqekwwgqsqwcoi = false)
    {
        return wp_get_attachment_image_url($aiooqyausygaasqm, $oiegiwogmwmawkeo, $wkaqekwwgqsqwcoi);
    }
    
    public static function uikkssqcoewckces($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\x74\x68\x75\x6d\142\x6e\141\x69\154", $wkaqekwwgqsqwcoi = false)
    {
        return wp_get_attachment_image_src($aiooqyausygaasqm, $oiegiwogmwmawkeo, $wkaqekwwgqsqwcoi);
    }
    
    public static function qaeeusqkgwagwaqc($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\x74\x68\165\x6d\x62\156\141\x69\x6c", $wisgiwskwawciiee = [], $wkaqekwwgqsqwcoi = false)
    {
