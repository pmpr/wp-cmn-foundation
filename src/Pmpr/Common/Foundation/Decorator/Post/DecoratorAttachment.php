...
class DecoratorAttachment extends Common
{
    ...
    public static function iaykyouimqoikagg($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\164\x68\x75\x6d\142\x6e\x61\151\x6c", $wkaqekwwgqsqwcoi = false)
    {
        return wp_get_attachment_image_url($aiooqyausygaasqm, $oiegiwogmwmawkeo, $wkaqekwwgqsqwcoi);
    }
    
    public static function uikkssqcoewckces($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\x74\150\x75\x6d\142\x6e\141\x69\x6c", $wkaqekwwgqsqwcoi = false)
    {
        return wp_get_attachment_image_src($aiooqyausygaasqm, $oiegiwogmwmawkeo, $wkaqekwwgqsqwcoi);
    }
    
    public static function qaeeusqkgwagwaqc($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\164\x68\x75\155\142\x6e\141\x69\x6c", $wisgiwskwawciiee = [], $wkaqekwwgqsqwcoi = false)
    {
