...
class DecoratorAttachment extends Common
{
    ...
    public static function iaykyouimqoikagg($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\x74\x68\x75\x6d\142\156\x61\151\154", $wkaqekwwgqsqwcoi = false)
    {
        return wp_get_attachment_image_url($aiooqyausygaasqm, $oiegiwogmwmawkeo, $wkaqekwwgqsqwcoi);
    }
    
    public static function uikkssqcoewckces($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\x74\150\x75\155\142\156\x61\151\154", $wkaqekwwgqsqwcoi = false)
    {
        return wp_get_attachment_image_src($aiooqyausygaasqm, $oiegiwogmwmawkeo, $wkaqekwwgqsqwcoi);
    }
    
    public static function qaeeusqkgwagwaqc($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\x74\x68\x75\155\x62\156\x61\151\x6c", $wisgiwskwawciiee = [], $wkaqekwwgqsqwcoi = false)
    {
