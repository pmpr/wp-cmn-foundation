...
class DecoratorAttachment extends Common
{
    ...
    public static function iaykyouimqoikagg($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\164\x68\x75\x6d\142\156\x61\151\x6c", $wkaqekwwgqsqwcoi = false)
    {
        return wp_get_attachment_image_url($aiooqyausygaasqm, $oiegiwogmwmawkeo, $wkaqekwwgqsqwcoi);
    }
    
    public static function uikkssqcoewckces($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\164\x68\165\155\x62\156\x61\151\154", $wkaqekwwgqsqwcoi = false)
    {
        return wp_get_attachment_image_src($aiooqyausygaasqm, $oiegiwogmwmawkeo, $wkaqekwwgqsqwcoi);
    }
    
    public static function qaeeusqkgwagwaqc($aiooqyausygaasqm, $oiegiwogmwmawkeo = "\164\150\165\155\142\x6e\x61\151\154", $wisgiwskwawciiee = [], $wkaqekwwgqsqwcoi = false)
    {
