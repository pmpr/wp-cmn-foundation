...
class Foreign extends Field
{
    ...
    {
        parent::__construct('foreign', $aokagokqyuysuksm, $meqocwsecsywiiqs);
    }
    ...
    public function wuuqgaekqeymecag() : self
    {
        ...
        if (!ManipulateString::ykemmsoumouomkqm($this->mwikyscisascoeea(), self::_ID)) {
            wp_die(sprintf(__('Foreign key %s must end with %s postfix', PR__CMN__FOUNDATION), $this->mwikyscisascoeea(), self::_ID));
        }
