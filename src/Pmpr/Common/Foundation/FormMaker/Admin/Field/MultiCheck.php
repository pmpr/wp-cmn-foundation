...
class MultiCheck extends OptionAwareField
{
    ...
    {
        parent::__construct("\x6d\x75\154\x74\x69\143\x68\x65\143\x6b", $aokagokqyuysuksm, $ymqmyyeuycgmigyo, $ukwokcuqauuosmoo, $qiouiwasaauyaaue);
        $this->usoqcyyugsuyiewc("\160\x72\x2d\x73\167\x69\164\143\x68");
    }
