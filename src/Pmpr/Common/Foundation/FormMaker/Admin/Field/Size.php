...
class Size extends Field
{
    ...
    {
        parent::__construct("\x73\151\172\x65", $aokagokqyuysuksm, $ymqmyyeuycgmigyo, $mkqqqewsokcswckc);
    }
    
    public function eyygsasuqmommkua($qeswwaqqsyymqawg = 50, $cswemwoyesycwkuq = 50) : Field
    {
        return parent::eyygsasuqmommkua(["\167\151\x64\x74\x68" => $qeswwaqqsyymqawg, "\150\145\x69\147\150\164" => $cswemwoyesycwkuq]);
    }
}
