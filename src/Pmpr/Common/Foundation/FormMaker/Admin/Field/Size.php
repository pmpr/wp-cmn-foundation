...
class Size extends Field
{
    ...
    {
        parent::__construct("\x73\x69\172\x65", $aokagokqyuysuksm, $ymqmyyeuycgmigyo, $mkqqqewsokcswckc);
    }
    
    public function eyygsasuqmommkua($qeswwaqqsyymqawg = 50, $cswemwoyesycwkuq = 50) : Field
    {
        return parent::eyygsasuqmommkua(["\167\151\x64\164\x68" => $qeswwaqqsyymqawg, "\x68\x65\x69\x67\x68\164" => $cswemwoyesycwkuq]);
    }
}
