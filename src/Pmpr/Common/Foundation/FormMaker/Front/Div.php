...
class Div extends Element
{
    ...
    {
        parent::__construct("\144\x69\166", $aokagokqyuysuksm);
    }
    ...
    {
        return $this->qigsyyqgewgskemg("\146\x6f\162\155\x2d\147\x72\x6f\165\160");
    }
    
    public function render($ywmkwiwkosakssii = []) : ?string
    {
        $ywmkwiwkosakssii["\x65\x63\x68\x6f"] = false;
