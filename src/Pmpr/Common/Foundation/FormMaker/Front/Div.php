...
class Div extends Element
{
    ...
    {
        parent::__construct("\144\151\x76", $aokagokqyuysuksm);
    }
    ...
    {
        return $this->qigsyyqgewgskemg("\146\157\162\x6d\x2d\147\162\157\165\160");
    }
    
    public function render($ywmkwiwkosakssii = []) : ?string
    {
        $ywmkwiwkosakssii["\145\x63\x68\157"] = false;
