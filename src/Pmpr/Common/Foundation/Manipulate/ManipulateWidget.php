...
class ManipulateWidget extends Manipulate
{
    ...
    {
        $ywmkwiwkosakssii = array_merge($ywmkwiwkosakssii, ["\x69\144" => $aokagokqyuysuksm, "\156\x61\x6d\145" => $ymqmyyeuycgmigyo]);
    ...
    public static function acsmmesauemikksg($assameyusgwogmce, $owgumcsyqsamiemg = [], $ywmkwiwkosakssii = [])
    {
        ...
        mymeomeemsgoeuck:
        return DecoratorHook::sscegwueamckwmcy(ManipulateHook::ygyygikyocoymgaw("\x77\x69\x64\147\x65\164\x5f\150\164\x6d\x6c"), $nsmgceoqaqogqmuw, $assameyusgwogmce);
